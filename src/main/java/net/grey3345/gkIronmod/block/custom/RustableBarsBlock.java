...
public class RustableBarsBlock extends IronBarsBlock implements WeatheringCopper {
    private final WeatheringCopper.WeatherState weatherState;

    public RustableBarsBlock(Properties properties, WeatherState weatherState) {
        super(properties);
