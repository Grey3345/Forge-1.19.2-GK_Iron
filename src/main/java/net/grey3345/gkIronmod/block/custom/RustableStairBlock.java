...
public class RustableStairBlock extends StairBlock implements WeatheringCopper {
    private final WeatheringCopper.WeatherState weatherState;

    public RustableStairBlock(Supplier<BlockState> state, Properties properties, WeatherState weatherState) {
