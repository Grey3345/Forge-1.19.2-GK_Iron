...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        ...
        for (Block block : ForgeRegistries.BLOCKS.getValues()) {
            if (block.defaultBlockState().is(BlockTags.BASE_STONE_OVERWORLD)) continue; // Blocks it can replace

            this.tag(ModTags.Blocks.WROUGHT_GEODE_CANNOT_REPLACE).add(block);
        }
    }
}
